...
export default function ParentMessages() {
  ...
  const [threads, setThreads] = useState<ParentMessageResponse["threads"]>([]);
  ...
  const loadThreads = async (markReadThreadId?: string | null) => {
    ...
    try {
      const data = await invokeSupabaseFunction<ParentMessageResponse>(
        "get-parent-messages",
      ...
      reportClientError("ParentMessages.loadThreads", err);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      reportClientError("ParentMessages.handleSend", err);
      const message = err instanceof Error ? err.message : String(err);
      toast({
    ...
    <ParentLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-foreground">Tutor Messages</h2>
            <p className="text-sm text-muted-foreground">
              Chat with your child&apos;s tutor inside the portal and keep the lesson trail in one place.
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Open a child profile and use In-App Chat to message the assigned tutor."
            icon={MessageCircle}
          />
        ) : (
              ...
              <div className="border-b border-border p-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search children or tutors..."
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Tutor: {thread.counterpart?.full_name ?? "Unassigned"}
                          </p>
                        </div>
              ...
              {selectedThread ? (
                  ...
                  <div className="border-b border-border p-5">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Tutor: {selectedThread.counterpart?.full_name ?? "Unassigned"}
                        </p>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {selectedThread.meeting
                            ...
                            : "Ask admin to configure recurring sessions."}
                        </p>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                          to={`/parent/children?student=${selectedThread.student?.id ?? ""}`}
                ...
                <div className="flex h-full min-h-[70vh] flex-col justify-between p-5">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      Send the first message for this child to open the tutor conversation inside the portal.
                    </p>
                  </div>
                ...
                <div className="flex min-h-[70vh] items-center justify-center">
                  <EmptyState
                    ...
                    description="Choose a child thread on the left to view and reply."
                    icon={MessageCircle}
                  />
                </div>
              )}
